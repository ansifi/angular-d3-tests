import { Component, VERSION, OnInit, Type } from '@angular/core';
import * as d3 from 'd3';
export type Datatype = { date: Date; value: string };
...
export class D3csvComponent implements OnInit {
  constructor() {}
  ...
  //Draws Dummy CSV graph with zoom feature
  drawCSV(): void {
